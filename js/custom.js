!function (e) {
    ...
    if (
        ...
        e(".site-header .header-nav li.sub > a").on("click", function (t) {
            if (1200 > l) {
                t.preventDefault();
                let i = e(this).parent("li"), o = e(this).siblings("ul");
                i.hasClass("active") ? (o.hide(), i.removeClass("active")): (o.show(), i.addClass("active"))
            }
        }),

        
        e('.humbarger').on("click", function(t){
               e('.menu-list').slideToggle(500);
               t.preventDefault();
        }),

    
        e("[data-background]").each(function () {
            let t = e(this).data("background");
        ...
        let r = e("input.datepicker").outerWidth();
        e("input.datepicker").datepicker(),
        e("body").append(
            "<style>.ui-datepicker{width:auto; min-width: " + r +
            "px !important;}</style>"
        )
    }
    if (
        e(".video-full").length && e(".video-full").fitVids(),
        e(".widget-slider").length && e(".widget-slider .widget-carousel").owlCarousel({
            items: 1,
            nav: !0,
            navText: [
                "", ""
            ...
            onInitialized: function () {
                e(".site-header").addClass("header-over"),
                e(".widget-rooms-carousel.top-over").length && e(".widget-slider").addClass(
                    "has-rooms"
                )
            }
        }),
        ...
        e(".widget-gallery-grid").length && e(".widget-gallery-grid .gallery-item a").imagesLoaded({
            ...
            let t = e(".widget-gallery-grid .row");
            ...
            e(".widget-filter-top ul li a").on("click", function (i) {
                i.preventDefault();
                let l = e(this).attr("data-filter");
                t.isotope({filter: l}),
                e(".widget-filter-top ul li").removeClass("active"),
                e(this)
                    .parent("li")
                    .addClass("active")
            })
        ...
        let n = e(".widget-rooms-detail .room-slider .owl-carousel"),
    ...
    if (
        e(".widget-blog-list").length && e(".widget-blog-list .media-gallery .media-carousel").owlCarousel({
            items: 1,
            navText: ["", ""]
        }),
        e(".widget-blog-carousel").length && (
            e(".widget-blog-carousel .widget-carousel").owlCarousel({
                ...
                onRefreshed: function () {
                    let t = e(".widget-blog-carousel .widget-carousel .blog-item"),
                        i = 0;
                    t.removeAttr("style"),
                    t.each(function () {
